...
namespace TennisBookings.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //binds matching property from featurs:homepage in appsetting to homepageconfiguration properties
            services.Configure<HomePageConfiguration>(Configuration.GetSection("Features:HomePage"));

            //to validate the config binded value
            services.TryAddEnumerable(ServiceDescriptor.Singleton<IValidateOptions<HomePageConfiguration>,
            ...
            //to throw error irrespective of the page where the config is required eg contact page if accessed
            // and if homepage config is invalid then error won't be thrown but with below method
            //app woudl be stopped if we access even contact page where the home page config is not required
